      ...
      <div className="about-us__wrapper">
        <div className="general-info">
          <div className="general-info__content">
            <motion.div custom={1} variants={verticalAnimation} className="general-info__title">NAMAT Global Trade</motion.div>
            <motion.div custom={2} variants={verticalAnimation} className="general-info__text">collaborate with leading manufacturers to provide our clients with the best innovative solutions that contribute to expanding their businesses</motion.div>
          </div>
          <Image src={BlueLine} alt='blue line' className="about-us_blue-line" />
        </div>
        <ul className="detailed-info">
          {detailedItemText.map((text, index) => (
            <motion.li custom={index + 1} variants={verticalAnimation} key={index} className="detailed-info__item">
