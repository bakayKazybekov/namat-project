    ...
    >
      <div className="services-header">
        <div className="services-title">
          <motion.span custom={1} variants={verticalAnimation}>Our Services</motion.span>
          <motion.div custom={2} variants={verticalAnimation} className="services-subtitle">In our company, there are four main directions.</motion.div>
        </div>
        <motion.div custom={1} variants={verticalAnimation} className="services__slider-buttons">
